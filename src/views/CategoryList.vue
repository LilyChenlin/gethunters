<template>
  <div class="cat-category-list">
    <el-breadcrumb>
      <el-breadcrumb-item>简历类别管理</el-breadcrumb-item>
      <el-breadcrumb-item>类别列表</el-breadcrumb-item>
    </el-breadcrumb>
    <br>
    <el-button @click="addCategory" type="primary">添加新的简历类别</el-button>
    <br>
